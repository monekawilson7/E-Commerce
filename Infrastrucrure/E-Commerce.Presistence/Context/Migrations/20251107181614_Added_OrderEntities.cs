...
{
    /// <inheritdoc />
    public partial class Added_OrderEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserEmail = table.Column<string>(type: "VarChar(128)", maxLength: 128, nullable: false),
                    Address_FristName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    PaymentIntentId = table.Column<string>(type: "VarChar(128)", maxLength: 128, nullable: false),
                    PaymentIntentName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
